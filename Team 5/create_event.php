        ...
        <div class="justify-content-center align-items-start content-box-shadow" id="add-event-container">
          ...
          <div class="row flex-column flex-md-row">
            <div class="form-group col-md-6">
                ...
                <textarea id="event-description" name="event-description" class="form-control second-layer" placeholder="Type Description Here" maxlength="255" required></textarea>
            </div>
            <div class="form-group col-md-6">
