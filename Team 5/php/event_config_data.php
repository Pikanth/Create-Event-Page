<?php
    ...
    if(isset($_POST['eventSaveBtn'])){
        ...
        if (mysqli_num_rows($result_event_name) > 0){
            ...
            header('Refresh: 3; url:list_of_events.php');
            header('Location: event_configuration.php?event name saved');
        }
    }  
    ...
    if(isset($_POST['categorySaveBtn'])){
        ...
        if (mysqli_num_rows($result_category_name) > 0){
            ...
            header('Location: event_configuration.php?Category Name Saved');
        }
    }
